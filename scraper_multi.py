...
def main():
    ...
    df_master.to_excel("tum_urunler_master.xlsx", index=False)
    
    print(f"🎉 İŞLEM TAMAM! Toplam {len(df_master)} satır veri 'tum_urunler_master.xlsx' dosyasına kaydedildi.")
